...
simulated-only, tool desconocida, filename traversal)** **21-23 (execution manifest: el binding genera manifest,
show-execution latest imprime "No command executed.", basename
